...
!!!DAPAT 7 UNDER22SCORE ANG NA EDIT MO  ( LINE 34 to 68 PASTE TO COREBABA SWITCH )
!@@@LeafSwitchONLY
config t
...
Int Range fa0/10-22
 ...
 switchport trunk allow vlan 1-999
 do sh int trunk
end
...
!!@@allow incoming calls bec. zero trust
configure terminal
voice service voip
...
network 10.22.22.0  0.0.0.255 area 0
network 10.22.1.0  0.0.0.255 area 22
network 10.22.10.0  0.0.0.255 area 22
network 10.22.50.0  0.0.0.255 area 22
...
http://docwiki.cisco.com/wiki/Cisco22IOS22Voice22Troubleshooting22and22Monitoring22--22Tcl22IVR22Troubleshooting
